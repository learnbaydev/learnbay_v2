...
import sliderData from '../../components/MasterClass/MasterData'; // Replace with the actual path to your data file
...
const Slider = () => {
  ...
  return (
    ...
    <div className={styles.conteiner}>
        <h2> <span className={styles.freegreen}>Join Our</span> Upcoming Masterclasses</h2>
    <Swiper
