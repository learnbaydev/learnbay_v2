...
<button  onClick={openWhatsApp}><MdOutlineWhatsapp className={styles.conicon}/>(+91) 77956 87988</button>
<button onClick={sendEmail}><AiOutlineMail className={styles.conicon}/> contacts@learnbay.co</button>
</div>
