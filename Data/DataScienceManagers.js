import {
  ...
  export const ManagersDataScienceCourseData = [
    {
      secondSection: [
        {
          id: 1,
      ...
      thirdSection: [
        ...
        },
        {
          ...
          para: "Minimum 6 year of IT/Non-IT work experience",
        },
        {
          id: 1,
          icon: <FaUserGraduate className={styles.oIcon} />,
          heading: "Career stage",
          para: "Mid-Senior professionals interested in Data Science & AI",
        },
        {
          id: 1,
          icon: <GiStairsGoal className={styles.bIcon} />,
          heading: "Aspirations",
          para: "Data Science & AI expertise for future opportunities ",
        },
      ],
      fourthSection: [
        {
