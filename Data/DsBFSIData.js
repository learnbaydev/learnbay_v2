import {
  ...
  export const DsBFSIScienceCourseData = [
    {
      secondSection: [
        {
          id: 1,
        ...
        },
        {
          ...
          para: "Master the domain of finance analytics with certificate from IBM",
        },
        {
          id: 1,
      ...
      thirdSection: [
        ...
        },
        {
          ...
          para: "Early to mid-career professionals interested in finance analytics",
        },
        {
          id: 1,
          icon: <GiStairsGoal className={styles.bIcon} />,
          heading: "Aspirations",
          para: "Utilise data-driven insights for business growth",
        },
      ],
      fourthSection: [
        {
      ...
      project: [
        {
          ...
          CLogo: "https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/NewDesignImage/JP.png",
          SDesc:
        ...
        },
        {
          ...
          SDesc:
          "Develop a customer segmentation system that uses data analytics......",
          PopupImg:
        ...
        },
        {
          ...
          CLogo: "https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/NewDesignImage/at%26t.png",
          SDesc:
        ...
        },
        {
          ...
          CLogo: "https://learnbay-wb.s3.ap-south-1.amazonaws.com/main/NewDesignImage/goldman.png",
          SDesc:
