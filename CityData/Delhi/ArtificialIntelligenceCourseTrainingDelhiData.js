export const AIelhiCourseData = [
 ...
 "url": "https://www.learnbay.co/"
      ...
      ProgramBot66:"Learnbay's main purpose is to provide high-quality Artificial Intelligence and Machine Learning training to aspirants in Delhi. Domain-specific modules are carefully crafted by industry experts and will be sent to you as part of your Artificial Intelligence training. Learnbay also provides blended learning sessions as well as live question-and-answer sessions. Because the modules are reasonable and flexible, with the option of 0% interest EMI, it is the best  Artificial Intelligence (AI) course for working professionals in Delhi. This IBM Artificial Intelligence course covers everything that a student seeking the best AI course training in Delhi will need to know.",
