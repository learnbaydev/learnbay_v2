    ...
    <div className={styles.container}>
      ...
      <main>
        ...
        <FirstSection
          ...
          firstHeading="Machine Learning Course Training In Chennai"
          firstTopPara="Machine Learning Course For Experienced Tech Professionals"
          idss="bfl64ANfSV0"

          
        />
        <SecondSection SecondSectionData={ MachineLearningChennaiCourseData[0].secondSection} />
        <Testimonial
          redirectDS={true}
        ...
        <div className="MainCities">
          ...
          <div className="CitiesRight">
            <CitiesRight
              ...
              CertificationHead1={ MachineLearningChennaiCourseData[0].CertificationHead1}
              CertificationBot1={ MachineLearningChennaiCourseData[0].CertificationBot1}
              ...
              SyllabusBotlist11={ MachineLearningChennaiCourseData[0].SyllabusBotlist11}
              SyllabusBotlist12={ MachineLearningChennaiCourseData[0].SyllabusBotlist12}
              SyllabusBotlist13={ MachineLearningChennaiCourseData[0].SyllabusBotlist13}
              SyllabusBotlist14={ MachineLearningChennaiCourseData[0].SyllabusBotlist14}
              SyllabusBotlist15={ MachineLearningChennaiCourseData[0].SyllabusBotlist15}
              SyllabusBotlist16={ MachineLearningChennaiCourseData[0].SyllabusBotlist16}
              syllabush2={ MachineLearningChennaiCourseData[0].syllabush2}
              syllabusb2={ MachineLearningChennaiCourseData[0].syllabusb2}
              SyllabusBotlist21={ MachineLearningChennaiCourseData[0].SyllabusBotlist21}
              SyllabusBotlist22={ MachineLearningChennaiCourseData[0].SyllabusBotlist22}
              SyllabusBotlist23={ MachineLearningChennaiCourseData[0].SyllabusBotlist23}
              SyllabusBotlist24={ MachineLearningChennaiCourseData[0].SyllabusBotlist24}
              SyllabusBotlist25={ MachineLearningChennaiCourseData[0].SyllabusBotlist25}
              SyllabusBotlist26={ MachineLearningChennaiCourseData[0].SyllabusBotlist26}
              syllabush3={ MachineLearningChennaiCourseData[0].syllabush3}
              syllabusb3={ MachineLearningChennaiCourseData[0].syllabusb3}
              SyllabusBotlist31={ MachineLearningChennaiCourseData[0].SyllabusBotlist31}
              SyllabusBotlist32={ MachineLearningChennaiCourseData[0].SyllabusBotlist32}
              SyllabusBotlist33={ MachineLearningChennaiCourseData[0].SyllabusBotlist33}
              SyllabusBotlist34={ MachineLearningChennaiCourseData[0].SyllabusBotlist34}
              SyllabusBotlist35={ MachineLearningChennaiCourseData[0].SyllabusBotlist35}
              SyllabusBotlist36={ MachineLearningChennaiCourseData[0].SyllabusBotlist36}
              syllabush4={ MachineLearningChennaiCourseData[0].syllabush4}
              syllabusb4={ MachineLearningChennaiCourseData[0].syllabusb4}
              SyllabusBotlist41={ MachineLearningChennaiCourseData[0].SyllabusBotlist41}
              SyllabusBotlist42={ MachineLearningChennaiCourseData[0].SyllabusBotlist42}
              SyllabusBotlist43={ MachineLearningChennaiCourseData[0].SyllabusBotlist43}
              SyllabusBotlist44={ MachineLearningChennaiCourseData[0].SyllabusBotlist44}
              SyllabusBotlist45={ MachineLearningChennaiCourseData[0].SyllabusBotlist45}
              SyllabusBotlist46={ MachineLearningChennaiCourseData[0].SyllabusBotlist46}
